...
return [
    ...
    */
    ...
    //     |--------------------------------------------------------------------------
    //     |
    //     | This is the middleware that will be used to identify the tenant for
    //     | incoming requests to Filament. You may add your own middleware to
    //     | this array to customize the tenant identification process.
    //     |
    //     */
